...
public class SpringAiBotTheme {
	 ...
	 * @throws Exception
	 */
	public SpringAiBotTheme(String tableCN, TableVo tableVo, String moduleName, String prefixPackage, String outPath, String beetlPath) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static void genSpringAibotTheme(DBService dbService) throws Exception {
		String packagePrefix = "com.szzt.aibot.business.";
		...
		for (TableVo curTableVo : dbService.getDbVo().getTableVoList()) {
			...
			if (curModule.isSkip()) {
				...
				SpringAiBotTheme fielVo = new SpringAiBotTheme(curModule.getTableCN(), curTableVo, curModule.getModelName(), packagePrefix, Config.outDir, Config.theme);
				fielVo.render();
			}
		}
